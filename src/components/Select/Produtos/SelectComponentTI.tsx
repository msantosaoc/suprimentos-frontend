...
import ModalCadastrarItemTI from '@/components/Modal/ModalCadastrarItemTI.tsx/page';
...
const SelectComponentTI: React.FC<SelectComponentProps> = ({ name, control, options, cadastrar, isDisabled, ...rest }) => {
    ...
    const toggleCadastrar = () => setCadastrarItem(!cadastrarItem);
            ...
            <Controller
                ...
                render={({ field }) => (
                    <Select
                        ...
                        isSearchable
                        noOptionsMessage={() => <ButtonCadastrar onClick={toggleCadastrar}>Cadastrar item</ButtonCadastrar>}
                        styles={{
...
export default SelectComponentTI;
