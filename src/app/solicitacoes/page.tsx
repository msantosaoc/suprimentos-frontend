...
export default function Solicitacoes() {
    ...
    const [solicitacoesProdutos, setSolicitacoesProdutos] = useState<ListarProdutosSolicitados[]>([{ id: '', name: '', resposta: '', status: '', usuario: { id: '', name: '' }, createdAt: '', categoria: { id: 0, name: '', }, unidade: { id: '', name: '' }, ProdutosSolicitados: [{ id: '', produto: '', produtoId: '', solicitacaoId: '', qtdeLiberada: null, qtde: 0 }] }]);
