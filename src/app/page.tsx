        ...
        <div className='h-full flex-1 bg-white rounded-e-xl flex flex-col text-black '>
          <div className='h-4/5 w-3/5 m-auto flex flex-col items-center gap-4  justify-center'>
            ...
            <div className='relative w-full flex justify-center'>
              ...
              <input type='email' placeholder='E-mail' className='border-[#d9d9d9] border rounded-md w-11/12 h-9 text-sm px-3 text-padrao' />
            ...
            <div className='relative w-full flex justify-center'>
              <input type='password' placeholder='Senha' className='border-[#d9d9d9] border rounded-md w-11/12 h-9 text-sm px-3 text-padrao' />
