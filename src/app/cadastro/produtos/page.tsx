...
export default function Produtos() {
    ...
    const [produtos, setProdutos] = useState<Produtos[]>([{ id: 0, name: '', createdAt: '', updatedAt: '', Categoria: { name: '' }, categoriaId: 0, Marca: {id: 0, name: '' }, marcaId: 0, cilindroId: '', dioptriaId: '', qtdeMax: '', qtdeMin: '', unidMedida: '', SubCategoria: {id: 0, name: ''} }]);
    ...
    const [selectedProduto, setSelectedProduto] = useState<Produtos>({ id: 0, name: '', createdAt: '', updatedAt: '', Categoria: { name: '' }, categoriaId: 0, Marca: {id: 0, name: '' }, marcaId: 0, cilindroId: '', dioptriaId: '', qtdeMax: '', qtdeMin: '', unidMedida: '', SubCategoria: {id: 0, name: ''} })
